                ...
                <div className="w3-content">
                    <div id="v-card" className="card">
                        <div className="card-content">
                            ...
                            <div className="infos">
                                <ul className="profile-list">
                                    <li className="clearfix">
                                        ...
                                        <span className="content ml-10px"><a href="mailto:givesachin@gmail.com">givesachin@gmail.com</a></span>
                                    </li>
                                    <li className="clearfix">
                            ...
                            <div className="links">
                                <a href="https://twitter.com" className="social btn-floating blue"><i className="fa fa-twitter"></i></a>
                                <a href="https://google.com" className="social btn-floating red ml-10px"><i className="fa fa-google-plus"></i></a>
                                <a href="https://linkedin.com" className="social btn-floating blue darken-3 ml-10px"><i className="fa fa-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
